...
# SEGUROS
def validate_376(nome_arquivo, linha, n, conn, dates,
                 entcodigo, ramcodigos, esrcodcess):
    tpmoids = [1001, 1002, 1003, 1004, 1005,
               1006, 1007, 1008, 1009, 1010, 1012, 1013]
    ...
    if (linha[27:31] in ["1001",
                         ...
                         "1010",
                         "1012",
                         "1013"] and linha[23:27] not in ["0001",
                                                          "0002",
                                                          "0003",
                                                          "0004",
                                                          "0005",
                                                          "0006"]) or (linha[27:31] in ["1011",
                                                                                        "1014"] and linha[23:27] not in ["0001",
                                                                                                                         "0002",
                                                                                                                         "0003",
                                                                                                                         "0004",
                                                                                                                         "0005",
    ...
    if linha[27:31] not in ["1001", "1002", "1003", "1004", "1005", "1006",
    ...
    # 1396, 1603 e 2201
    if linha[27:31] in ["583", "588", "589", "983", "986", "991", "992",
                        "994", "1066", "1286", "1383", "1386", "1391",
                        "1392", "1603"]:
