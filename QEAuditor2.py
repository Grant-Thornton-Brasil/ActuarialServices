...
class main_window():
    ...
    def design(self):
        ...
        self.arquivos_button_clear = Button(self.arquivos_frame,
                                      text="Limpar",
                                      command=lambda: self.arquivos_text.delete("1.0",END),
                                      height=6,
                                      width=12)
    ...
    def positions(self):
        ...
        self.arquivos_button_clear.grid(row=0,column=2,sticky=S,columnspan=2)
        ...
        # Tree Process
        self.process_tree_frame.grid(row=1,column=0,columnspan=2)
        ...
        self.status_frame
        self.status_label
        self.status_execute_button
        self.status_cancel_button
